...
from pre_tournament.pool_alch_agent.models import Assignment, PoolConfig, PoolFencer, Score, Weights
...
from pre_tournament.pool_alch_agent.reader import read_pools_from_sheet
