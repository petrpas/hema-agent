...
from pre_tournament.pool_alch_agent.models import (
    Assignment,
    PoolConfig,
    PoolFencer,
    Score,
...
def deps_from_state(state: PoolAlchState, channel, config) -> "PoolAlchDeps":  # type: ignore[name-defined]
    ...
    from pre_tournament.pool_alch_agent.pool_alch_agent import PoolAlchDeps  # local import avoids circularity
