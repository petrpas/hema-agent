...
def parse_transactions(raw_content: str, config: PreConfig) -> list[ParsedTransaction]:
...
def match_payments(
    ...
    agent = Agent(
        ...
        model_settings=ModelSettings(temperature=0.0, max_tokens=16384),
...
def parse_and_store(raw_content: str, filename: str, data_dir: Path, config: PreConfig) -> list[ParsedTransaction]:
