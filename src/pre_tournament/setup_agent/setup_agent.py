...
# Push src/ onto sys.path so `pre_tournament.*` and `shared.*` imports resolve
...
import discord
from shared.config.tracing import observe, enabled as _tracing_enabled
...
from pre_tournament.msgs import render_msg as _render_msg, read_msg as _read_msg

log = logging.getLogger(__name__)

_DEFAULT_USER_CONFIG = _SRC_ROOT / "pre_tournament" / "config" / "pre_user_config.json"
SHARED_MEMORY_PATH = Path(__file__).parent / "setup_memory.md"
