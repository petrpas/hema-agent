...
#set table(
  stroke: (x, y) => (
    ...
    left: if x == 0 or x == 1 or x == 5 { 1.5pt } else {0.5pt},
    right: if x == 8 { 1.5pt } else {0.5pt},
    bottom: 1.5pt,
  ),
)
...
#table(
  ...
  columns: (4fr, 1.5fr, 1.5fr, 1.5fr, 1.5fr, 1fr, 1fr, 1fr, 1fr),
  inset: (y: 10pt),
  table.header(
...
#table(
  ...
  [1],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_4}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_1}}]],[],[],
  [2],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_3}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_2}}]],[],[],
  [3],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_4}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_2}}]],[],[],
  [4],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_1}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_3}}]],[],[],
  [5],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_3}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_4}}]],[],[],
  [6],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_2}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_1}}]],[],[],
)
