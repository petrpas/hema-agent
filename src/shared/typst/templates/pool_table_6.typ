...
#table(
  ...
  [1],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_6}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_1}}]],[],[],
  [2],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_5}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_2}}]],[],[],
  [3],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_4}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_3}}]],[],[],
  [4],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_6}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_2}}]],[],[],
  [5],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_1}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_3}}]],[],[],
  [6],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_5}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_4}}]],[],[],
  [7],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_6}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_3}}]],[],[],
  [8],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_2}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_4}}]],[],[],
  [9],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_1}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_5}}]],[],[],
  [10],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_4}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_6}}]],[],[],
  [11],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_3}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_5}}]],[],[],
  [12],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_2}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_1}}]],[],[],
  [13],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_5}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_6}}]],[],[],
  [14],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_4}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_1}}]],[],[],
  [15],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_3}}]],box(width: 100%, height: 0.85em, clip: true)[#nowrap[{{fencer_2}}]],[],[],
)
